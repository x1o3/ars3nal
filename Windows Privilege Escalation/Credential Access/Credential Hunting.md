...
- [[#Password Managers]]
- [[#[LaZagne](https //github.com/AlessandroZ/LaZagne) & [SessionGopher](https //github.com/Arvanaghi/SessionGopher)|LaZagne & SessionGopher]]
...
##  [LaZagne](https://github.com/AlessandroZ/LaZagne) & [SessionGopher](https://github.com/Arvanaghi/SessionGopher) 
...
[SessionGopher](https://github.com/Arvanaghi/SessionGopher) extracts PuTTY, WinSCP, FileZilla, SuperPuTTY, and RDP creds, It can also be run to search drives for PuTTY private key files (.ppk), Remote Desktop (.rdp), and RSA (.sdtid) files. earches the `HKEY_USERS` hive for all users who have logged into a domain-joined host. We need local admin access to retrieve stored session information for every user in `HKEY_USERS`.
